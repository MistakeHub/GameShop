              ...
              if(this.session ==undefined){
               ...
               console.log( this.$hostname)
                    ...
                    'set-cookie':document.cookie}}).then(Response=>
                           { this.publications=Response.data.item1;this.countPublication=Response.data.item2; this.isHaveModal=true;this.Type="Platform";   console.log(this.publications)  ;this.fileds=['id', 'titleofplatform', { key: 'actions', label: 'Actions' }]} ).catch(d=>{
              if(d.response)
